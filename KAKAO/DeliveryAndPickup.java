...
class DeliveryAndPickup {
    public long solution(int cap, int n, int[] deliveries, int[] pickups) {
        long answer = 0;

        int deliveriesCount = 0, pickupsCount = 0;
        ...
        for (int i = n - 1; i >= 0; i--) {
            ...
            while (deliveriesCount > 0 || pickupsCount > 0) {
                deliveriesCount -= cap; // 출발 시에 용량 만큼 모두 배달
                pickupsCount -= cap; // 돌아갈 시에 용량 만큼 모두 수거
                count++;
            }
            answer += (i + 1) * 2 * count;
            // 2는 2번 왔다리 갔다리
    ...
    public static void main(String[] args) {
        ...
        new DeliveryAndPickup().solution(2, 7, deliveries, pickups);
        System.out.println("김 모 띠");
    }
}
